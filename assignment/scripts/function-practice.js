...
// Code needs to return 'Hello, name!' 
function helloName( name ) {
  return 'Hello, ' + name + '!';
} //end helloName
// Remember to call the function to test
console.log (helloName('Rider'));

// 3. Function to add two numbers together & return the result
// Need to add second number
...
//Need to create three paramaters, then return num1 * num2 * num 3 
...
// When number is greater than zero it will return true, otherwise return false
